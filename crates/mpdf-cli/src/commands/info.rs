...
use mpdf_core::{analysis, pipeline, ProjectInfo};
use serde::Serialize;
...
pub const INFO_REPORT_SCHEMA: &str = "mpdf-info";
...
fn build_report(pdfium: PdfiumInfo) -> ReportEnvelope<InfoReport> {
    ...
    let result = InfoReport {
        ...
        report_schemas: vec![
            ...
            SchemaVersion {
                schema: mpdf_core::report::ERROR_SCHEMA,
                version: mpdf_core::report::ERROR_SCHEMA_VERSION,
            },
        ],
        pdfium,
        limitations: vec![
