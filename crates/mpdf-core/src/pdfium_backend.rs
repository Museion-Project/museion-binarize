...
pub const PDFIUM_LIBRARY_ENV: &str = "MPDF_PDFIUM_LIBRARY";
...
pub const ALLOW_CWD_PDFIUM_ENV: &str = "MPDF_ALLOW_CWD_PDFIUM";
...
impl LibrarySource {
    pub fn describe(self) -> &'static str {
        match self {
            ...
            LibrarySource::Environment => "MPDF_PDFIUM_LIBRARY environment variable",
...
fn search_candidates(file_name: &str) -> Vec<(LibrarySource, PathBuf)> {
    ...
    // set MPDF_PDFIUM_LIBRARY instead.
