//! Versioned benchmark dataset manifest: `mpdf-benchmark-dataset`.
//!
...
pub const DATASET_SCHEMA: &str = "mpdf-benchmark-dataset";
...
"#
    ...
    fn rejects_wrong_schema() {
        let dir = tempfile::tempdir().unwrap();
        let bad = minimal_manifest_toml().replace("mpdf-benchmark-dataset", "some-other-schema");
