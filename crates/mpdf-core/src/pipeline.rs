...
pub const PROCESS_REPORT_SCHEMA: &str = "mpdf-process";
...
pub const TEMP_FILE_PREFIX: &str = ".mpdf-";

/// Convenience: returns the paths of any leftover M PDF temporary files
