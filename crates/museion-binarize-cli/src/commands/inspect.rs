...
use museion_binarize_core::document_session::PdfOpenOptions;
use museion_binarize_core::page_geometry::points_to_pixels;
use museion_binarize_core::pipeline;
use museion_binarize_core::report::{display_path, PathMode, ReportEnvelope};
...
pub const INSPECT_REPORT_SCHEMA: &str = "museion-binarize-inspect";
...
fn fail(
    error: &museion_binarize_core::error::CoreError,
    input: &std::path::Path,
    json: bool,
    pretty: bool,
) -> ExitCode {
...
mod tests {
    use super::*;
    use museion_binarize_core::document::{PdfMetadata, PdfPageInfo};
    use museion_binarize_core::page_geometry::{PageGeometry, PageRotation};
