...
use museion_binarize_core::benchmark::report::{
...
fn print_human(report: &BenchmarkReport) {
    ...
    println!(
        ...
        match report.environment.benchmark_level {
            museion_binarize_core::benchmark::report::BenchmarkLevel::Raster => "raster",
            museion_binarize_core::benchmark::report::BenchmarkLevel::Pdf => "pdf",
        }
    );
    println!();
    println!(
