...
use museion_binarize_core::report::PathMode;
    ...
    pub fn to_settings(&self) -> Result<ProcessingSettings, String> {
        ...
        let method = match self.method {
            ...
            MethodArg::Sauvola => BinarizationMethod::Sauvola(SauvolaParams {
                window_size: self.sauvola_window.unwrap_or_else(|| {
                    museion_binarize_core::binarization::sauvola_window_for_dpi(self.dpi)
                }),
...
mod tests {
    use super::*;
    use museion_binarize_core::binarization::sauvola_window_for_dpi;
    ...
    fn cli_parses_without_a_subcommand() {
        use clap::Parser;
        let cli = Cli::parse_from(["museion-binarize"]);
